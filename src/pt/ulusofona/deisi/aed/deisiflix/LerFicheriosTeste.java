...
public class LerFicheriosTeste {

    static void functionTeste() throws IOException {
        //long start, end;
        String linha;
        ...
        FileReader fr1 = new FileReader("test-files/deisi_movies.txt");
        ...
        FileReader fr2 = new FileReader("test-files/deisi_movie_votes.txt");
        ...
        FileReader fr3 = new FileReader("test-files/deisi_people.txt");
        ...
        FileReader fr4 = new FileReader("test-files/deisi_genres.txt");
